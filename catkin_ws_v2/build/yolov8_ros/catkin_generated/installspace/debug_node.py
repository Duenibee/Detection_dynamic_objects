...
class DebugNode():
    ...
    def __init__(self) -> None:
        ...
        self._bb_markers_pub = rospy.Publisher(
            "dgb_bb_markers", MarkerArray, queue_size = 10)
        self._kp_markers_pub = rospy.Publisher(
            "dgb_kp_markers",MarkerArray,queue_size = 10)
    ...
    def create_bb_marker(self, detection: Detection) -> Marker:
        ...
        marker.lifetime = rospy.Duration(secs=0.5)
    ...
    def detections_cb(self, img_msg: Image, detection_msg: DetectionArray) -> None:
        ...
        cv_image_copy.flags.writeable= True 
        # print(cv_image.flags.writeable)
        detection: Detection
        for detection in detection_msg.detections:
            ...
            cv_image_copy = self.draw_box(cv_image_copy, detection, color)
            cv_image_copy = self.draw_mask(cv_image_copy, detection, color)
            cv_image_copy = self.draw_keypoints(cv_image_copy, detection)
        ...
        # publish dbg image
        self._dbg_pub.publish(self.cv_bridge.cv2_to_imgmsg(cv_image_copy,
