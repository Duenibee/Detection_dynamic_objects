...
class Yolov8Node():
    ...
    def __init__(self) -> None:
        ...
        self.yolo = YOLO("/home/dyros/catkin_junhee_ws/src/yolov8_ros/weights/yolov8m-seg.pt")
        self.threshold=0.8
        self.enable= True
        self.device='0'
        # pubs
    ...
    def image_cb(self, msg: Image) -> None:
        ...
        if self.enable:
            ...
            results = self.yolo.track(
                ...
                conf=self.threshold,
                device=self.device,
                tracker='/home/dyros/catkin_junhee_ws/src/yolov8_ros/param/custom_tracker.yaml'
            )
